...
import { evaluate, parse, registerFunction } from '..'
...
test('formula:date', () => {
  ...
  expect(evalFormual('DATETOSTR(DATE(2021, 11, 21, 0, 0, 0), "YYYY-MM-DD")')).toBe('2021-12-21')
  expect(evalFormual('DATETOSTR(DATE("2021-12-21"), "YYYY-MM-DD")')).toBe('2021-12-21')
  expect(evalFormual('DATETOSTR(TODAY(), "YYYY-MM-DD")')).toBe(moment().format('YYYY-MM-DD'))
  expect(evalFormual('DATETOSTR(NOW(), "YYYY-MM-DD")')).toBe(moment().format('YYYY-MM-DD'))
  ...
  expect(evalFormual('DATETOSTR("2022年12月25日 14时23分56秒", "YYYY/MM/DD HH:mm:ss")')).toBe(
    moment('2022年12月25日 14时23分56秒', 'YYYY-MM-DD HH:mm:ss').format('YYYY/MM/DD HH:mm:ss')
  )
  ...
  expect(evalFormual('DATETOSTR("2010-10-20 4:30 +0000", "YYYY-MM-DD HH:mm Z")')).toBe(
    moment('2010-10-20 4:30 +0000').format('YYYY-MM-DD HH:mm Z')
  )
  expect(evalFormual('DATETOSTR("2013-02-04T10:35:24-08:00", "YYYY-MM-DD HH:mm:ss")')).toBe(
    moment('2013-02-04T10:35:24-08:00').format('YYYY-MM-DD HH:mm:ss')
  )
  expect(evalFormual('YEAR(STRTODATE("2021-10-24 10:10:10"))')).toBe(2021)
  expect(
    evalFormual('DATERANGESPLIT("1676563200,1676735999", undefined, "YYYY.MM.DD hh:mm:ss")')
  ).toEqual(['2023.02.17 12:00:00', '2023.02.18 11:59:59'])
  expect(evalFormual('DATERANGESPLIT("1676563200,1676735999", 0)')).toBe('1676563200')
  expect(evalFormual('DATERANGESPLIT("1676563200,1676735999", 0 , "YYYY.MM.DD hh:mm:ss")')).toBe(
    '2023.02.17 12:00:00'
  )
  expect(
    evalFormual('DATERANGESPLIT("1676563200,1676735999", "start" , "YYYY.MM.DD hh:mm:ss")')
  ).toBe('2023.02.17 12:00:00')
  expect(evalFormual('DATERANGESPLIT("1676563200,1676735999", 1 , "YYYY.MM.DD hh:mm:ss")')).toBe(
    '2023.02.18 11:59:59'
  )
  expect(
    evalFormual('DATERANGESPLIT("1676563200,1676735999", "end" , "YYYY.MM.DD hh:mm:ss")')
  ).toBe('2023.02.18 11:59:59')
  expect(evalFormual('WEEKDAY("2023-02-27")')).toBe(moment('2023-02-27').weekday())
  expect(evalFormual('WEEKDAY("2023-02-27", 2)')).toBe(moment('2023-02-27').isoWeekday())
  expect(evalFormual('WEEK("2023-03-05")')).toBe(moment('2023-03-05').week())
  expect(evalFormual('BETWEENRANGE("2023-03-08", ["2023-03-01", "2024-04-07"], "year")')).toBe(
    moment('2023-03-08').isBetween('2023-03-01', '2024-04-07', 'year', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2022-03-08", ["2023-03-01", "2024-04-07"], "year")')).toBe(
    moment('2022-03-08').isBetween('2023-03-01', '2024-04-07', 'year', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2023-03-08", ["2023-03-01", "2023-04-07"], "month")')).toBe(
    moment('2023-03-08').isBetween('2023-03-01', '2023-04-07', 'month', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2023-05-08", ["2023-03-01", "2023-04-07", "month"])')).toBe(
    moment('2023-05-08').isBetween('2023-03-01', '2023-04-07', 'month', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2023-03-06", ["2023-03-01", "2023-05-07"])')).toBe(
    moment('2023-03-06').isBetween('2023-03-01', '2023-05-07', 'day', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2023-05-08", ["2023-03-01", "2023-05-07"])')).toBe(
    moment('2023-05-08').isBetween('2023-03-01', '2023-05-07', 'day', '[]')
  )
  expect(evalFormual('BETWEENRANGE("2023-05-07", ["2023-03-01", "2023-05-07"], "day", "()")')).toBe(
    moment('2023-05-07').isBetween('2023-03-01', '2023-05-07', 'day', '()')
  )
  expect(
    evalFormual('CONCATENATE(STARTOF("2023-02-28", "day"), "," ,ENDOF("2023-02-28", "day"))')
  ).toBe(
    `${moment('2023-02-28').startOf('day').toDate()},${moment('2023-02-28').endOf('day').toDate()}`
  )
  expect(
    evalFormual(
    ...
    `${moment('2023-02-28').startOf('day').format('YYYY-MM-DD HH:mm:ss')},${moment('2023-02-28')
      .endOf('day')
